   ...
   <div class="tabContainer">
    <div id="tabsHeader-1" class="tabContent">
     <ul class="column header_field">
      <li><?php $f->l_text_field_dr_withSearch('qa_collection_element_header_id') ?>
      ...
      <li><?php $f->l_select_field_from_array('display_type', qa_collection_element_header::$display_type_a, $$class->display_type); ?>       </li>
     ...
     <div> 
      <div id="comments">
       ...
       <div id ="display_comment_form">
        <?php
        $reference_table = 'qa_collection_element_header';
        $reference_id = $$class->qa_collection_element_header_id;
        ?>
       </div>
       <div id="new_comment">
       </div>
...
<div id="tabsLine">
 ...
 <div class="tabContainer">
    ...
    <div id="tabsLine-1" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody">
       <?php
       $count = 0;
       foreach ($qa_collection_element_line_object as $qa_collection_element_line) {
        ...
        ?>         
        <tr class="qa_collection_element_line<?php echo $count ?>">
         <td>
          <?php
  ...
  <div id ="form_line2" class="form_line2">
   <form action=""  method="post" id="qa_collection_element_action"  name="qa_collection_element_action">
    <div id="tabsLine-2" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody2 wip_wo_bom_values" >
       <?php
       $count = 0;
       foreach ($qa_collection_element_action_object as $qa_collection_element_action) {
        ?>         
        <tr class="qa_collection_element_action<?php echo $count ?>">
         <td>    
          <ul class="inline_action">
           <li class="add_row_img"><i class="fa fa-plus-circle"></i></li>
           <li class="remove_row_img"><i class="fa fa-minus-circle"></i></li>
           <li><input type="checkbox" name="line_id_cb" value="<?php echo htmlentities($qa_collection_element_action->qa_collection_element_action_id); ?>"></li>           
           <li><?php echo form::hidden_field('qa_collection_element_header_id', $$class->qa_collection_element_header_id); ?></li>
          </ul>
         </td>
...
<div id="js_data">
 <ul id="js_saving_data">
  <li class="headerClassName" data-headerClassName="qa_collection_element_header" ></li>
  <li class="lineClassName" data-lineClassName="qa_collection_element_line" ></li>
  <li class="lineClassName2" data-lineClassName2="qa_collection_element_action" ></li>
  <li class="savingOnlyHeader" data-savingOnlyHeader="false" ></li>
  <li class="primary_column_id" data-primary_column_id="qa_collection_element_header_id" ></li>
  <li class="form_header_id" data-form_header_id="qa_collection_element_header" ></li>
  <li class="line_key_field" data-line_key_field="item_description" ></li>
  <li class="single_line" data-single_line="false" ></li>
  <li class="form_line_id" data-form_line_id="qa_collection_element_line" ></li>
 </ul>
 <ul id="js_contextMenu_data">
  <li class="docHedaderId" data-docHedaderId="qa_collection_element_header_id" ></li>
  <li class="docLineId" data-docLineId="qa_collection_element_line_id" ></li>
  <li class="btn1DivId" data-btn1DivId="qa_collection_element_header" ></li>
